...
from db.db_save import save_conversation, save_feedback, save_expenses_to_sqlite
from judge import evaluate_relevance

assistant = create_assistant()

st.title("Expense Analyst")
uploaded_file = st.file_uploader("Upload your data source",type="csv", accept_multiple_files=False)


if uploaded_file:
    user_input = st.text_input("Enter your question:")
    save_expenses_to_sqlite(uploaded_file)
